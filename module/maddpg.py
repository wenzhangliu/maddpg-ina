...
class Agent_model():
    def __init__(self, agent_ID, args, memory):
        self.ID = agent_ID
        self.dim_o = args.dim_o_pre
        self.dim_a = args.dim_a_pre
        self.n_agents = args.n_old_agents
        ...
        if args.phase == 0:
            ...
            self.label = "Phase_" + str(args.phase-1) + "_"
        ...
        self.param_a = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES,
                                         scope=self.label+"actor_net_agt_" + str(self.ID))
        self.param_c = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES,
                                         scope=self.label+"critic_net_agt_" + str(self.ID))
